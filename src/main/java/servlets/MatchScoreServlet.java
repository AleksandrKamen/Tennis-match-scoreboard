    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (matchState == MatchState.NOT_OVER) {
                ...
                req.getSession().setAttribute("playerScore1", currentMatches.getScore().getPlayerScore(0).getString());
                req.getSession().setAttribute("playerScore2", currentMatches.getScore().getPlayerScore(1).getString());
