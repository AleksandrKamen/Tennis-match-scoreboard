...
<div id="menu">
    ...
    <form action="new-match" method="post" enctype="application/x-www-form-urlencoded">
        ...
        <input type="text" id="playerName1" name="playerName1" maxlength="30" required
        ...
        <input type="text" id="playerName2" name="playerName2" maxlength="30" required
               placeholder="<fmt:message key="matches.example"></fmt:message>Rafael Nadal">

        <div class="button">
            <button type="submit" style="font-weight: bold; width: 10vw; height: 2vw; cursor: pointer"><fmt:message
                    key="newMatch.start"></fmt:message></button>
        </div>
    </form>
